...
namespace FilmReviewerApp.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(FilmReviewerAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'FilmReviewerAppContext.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FilmReviewerAppContext.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
